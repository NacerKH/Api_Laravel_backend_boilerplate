...
<script>
import ImageListItem from "../../components/Listing/ImageListItem.vue";
import ThumbListItem from "../../components/Listing/ThumbListItem.vue";
import DataListItem from "../../components/Listing/DataListItem.vue";
export default {
  components: {
