<template>
  <div class="disable-text-selection">
    ...
    <contextmenu ref="contextmenu" @contextmenu="handleContextmenu">
      <contextmenu-item @click="onContextCopy()">
        <i class="simple-icon-docs" />
        <span>Copy</span>
      </contextmenu-item>
      <contextmenu-item @click="onContextArchive()">
        <i class="simple-icon-drawer" />
        <span>Move to archive</span>
      </contextmenu-item>
      <contextmenu-item @click="onContextDelete()">
...
import TodoListItem from "../../../../components/TodoApp/TodoListItem.vue";
import ApplicationMenu from "../../../../components/Common/ApplicationMenu.vue";
import TodoApplicationMenu from "../../../../containers/applications/TodoApplicationMenu.vue";
import TodoAddNewModal from "../../../../containers/applications/TodoAddNewModal.vue";
